...
granger = User.find_or_create_by!(name: 'Granger Abuhoff', email: 'grangerabuhoff@gmail.com', password: 'password 1')
diego = User.find_or_create_by!(name: 'Diego  Zuluaga', email: 'diegozuluaga88@gmail.com', password: 'password 2',)
nico = User.find_or_create_by!(name: 'Nicolle Jasbon', email: 'njasbon@gmail.com', password: 'password 3')
mattk = User.find_or_create_by!(name: 'Matt Kirk', email: 'matt.22222@hotmail.com', password: 'password 4')
angel = User.find_or_create_by!(name: 'Angel Medina', email: 'angelmmed12@gmail.com', password: 'password 5')
flo = User.find_or_create_by!(name: 'Florrette Masillon', email: 'floman@agrinya.org', password: 'password 6')
ana = User.find_or_create_by!(name: 'Ana Cristina Stanic', email: 'acp411@hotmail.com', password: 'password 7')
gabriel = User.find_or_create_by!(name: 'Gabriel Jasbon', email: 'gabe08@hotmail.com', password: 'password 8')
